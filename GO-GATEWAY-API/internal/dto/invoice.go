...
func ToInvoice(input CreateInvoiceInput, accontID string) (*domain.Invoice, error) {
	...
	return domain.NewInvoice(accontID, input.Amount, input.Description, input.PaymentType, card)
